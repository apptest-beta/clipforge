...
// Fixed, full-viewport animated shader background. Mount once near the root
// of the app so it sits behind all page content.
export default function ShaderBackground() {
  ...
  return (
    <canvas
      ref={canvasRef}
      className="fixed inset-0 -z-50 h-full w-full touch-none"
